...
const AddReview = props => {
    ...
    const
        [review, setReview] = useState(initialReviewState),
        [submitted, setSubmitted] = useState(false),
        handleInputChange = e => { setReview(e.target.value) },
        saveReview = () => {
            let data = {
                text: review,
                        ...
                        <div>
                            <div className="container col-md-6">
                                ...
                                <div className="form-group">
                                    <input type="text" className="form-control" id="text" name="text" value={review} onChange={handleInputChange} required autoFocus={true} />
                                </div>
